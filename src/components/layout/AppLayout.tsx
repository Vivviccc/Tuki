      ...
      <header className="sticky top-0 z-[1100] h-16 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-[#090d16]/80 backdrop-blur-xl px-4 lg:px-8 flex items-center justify-between shadow-sm transition-colors duration-300">
        ...
        <div className="flex items-center gap-4">
          <Link to="/groups" className="flex items-center gap-2 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-amber-500 to-amber-700 flex items-center justify-center shadow-glow-amber transition-transform group-hover:scale-105">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-amber-500/50 text-xs font-semibold transition-colors"
            >
            ...
            {isGroupDropdownOpen && (
              <div
                className="absolute left-0 mt-2 w-64 rounded-2xl bg-[#141a29] border border-slate-800 shadow-2xl p-2 z-50 animate-fade-in"
                onMouseLeave={() => setIsGroupDropdownOpen(false)}
              >
                <div className="px-3 py-1.5 text-[10px] font-mono font-bold text-amber-400/90 uppercase tracking-widest">
                  // Squad Maps
                </div>
                ...
                <div className="pt-2 border-t border-slate-800 grid grid-cols-2 gap-1.5">
                  <button
                    ...
                    className="flex items-center justify-center gap-1 p-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-[11px] font-extrabold text-slate-950 transition-colors shadow-glow-amber"
                  >
                  ...
                  >
                    <UserPlus className="w-3 h-3 text-teal-400" /> Join Code
                  </button>
                </div>
              </div>
            )}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {activeGroupId && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-extrabold shadow-glow-amber transition-all hover:scale-105"
            >
